class ImageConstant {
  ...
  // Sign In / Phone number / Default images
  static String imgTelevision = '$imagePath/img_television.svg';

  static String imgArrowDown = '$imagePath/img_arrow_down.svg';

  // Sign In / Phone number / Verify Number / images
  static String imgAccent252x154 = '$imagePath/img_accent_252x154.png';

  // Sign In / Email / Default - Tab Container images
  static String imgAccent1 = '$imagePath/img_accent_1.png';

  // Forgot Password / Phone number / Active images
  static String imgAccent2 = '$imagePath/img_accent_2.png';

  // Forgot Password / Phone number / Verify Number / OTP images
  static String imgAccent3 = '$imagePath/img_accent_3.png';

  // Forgot Password / Create New Password / Active images
  static String imgAccent4 = '$imagePath/img_accent_4.png';

  // Forgot Password / Success! images
  static String imgAccent5 = '$imagePath/img_accent_5.png';

  // Registration / Step 1 / Active images
  static String imgAccent6 = '$imagePath/img_accent_6.png';

  // Registration / Step 2 / Active images
  static String imgAccent7 = '$imagePath/img_accent_7.png';

  // Registration / Step 3 / Active images
  static String imgAccent8 = '$imagePath/img_accent_8.png';

  static String imgIconGray900 = '$imagePath/img_icon_gray_900.svg';

  // Registration / Step 4 / Active images
  static String imgAccent9 = '$imagePath/img_accent_9.png';

  // Registration / Step 5 / Active images
  static String imgAccent10 = '$imagePath/img_accent_10.png';

  static String imgCheck = '$imagePath/img_check.svg';

  // Registration / Step 6 / Default images
  static String imgAccent11 = '$imagePath/img_accent_11.png';

  // Registration / Step 6 / Popup images
  static String imgAccent12 = '$imagePath/img_accent_12.png';

  // Registration / Step 6 / Gallery images
  static String imgSearch = '$imagePath/img_search.svg';

  static String imgSuccessfulBusinessman =
      '$imagePath/img_successful_businessman.png';

  // Registration / Step 6 / Adjustment images
  static String imgSuccessfulBusinessman343x375 =
      '$imagePath/img_successful_businessman_343x375.png';

  static String imgGroup973 = '$imagePath/img_group_973.svg';

  static String imgCross11 = '$imagePath/img_cross_1_1.svg';

  static String imgTick1 = '$imagePath/img_tick_1.svg';

  // Registration / Step 6 / Done images
  ...
  // Registration / Step 7 / Default images
